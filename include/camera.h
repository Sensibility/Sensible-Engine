...
public:
    Camera(){}
    Camera(float x, float y, float z, float dirX, float dirY, float dirZ, float upX, float upY, float upZ, float theta, float phi, float radius, std::string type, std::string focus){
        this->x = x;
        this->y = y;
        this->z = z;
        this->dirX = dirX;
